...
export const UserListItem = ({ login, avatar_url, id }: IUserListItem) => {
  return (
    <Link
      to={`/user/${login}`}
      aria-label='suer-list-item'
      className='relative flex items-center gap-10 rounded-lg bg-gray-50 p-5 shadow-md'
    >
      ...
      <div className='absolute right-3 top-3 text-xs font-bold text-gray-600'>
